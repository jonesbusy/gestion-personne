/*==============================================================*
 | Implementation file AskProfessor.cpp
 |    implements : AskProfessor class
 |
...
*/
std::vector<std::string> * AskProfessor::askInfo()
{

    std::cout << std::endl << "Veuillez saisir les informations du professeur"  << std::endl;
    std::cout              << "-----------------------------------------------" << std::endl;
...
* @return UINT : salary
*/
std::string AskProfessor::askMethod(std::string messageInvit, std::string messageError, bool(* checker)(std::string&))
{
    // For getting info
    std::string info;
...
*/
std::string AskProfessor::askLastName()
{
...
*/
std::string AskProfessor::askFirstName()
{
...
*/
std::string AskProfessor::askBirthday()
{
...
*/
std::string AskProfessor::askAdress()
{
...
*/
USINT AskProfessor::askNPA()
{
    return atoi(this->askMethod("Donnez le numero postal [1000-9999]", errorNumber, CheckPersonProfessorStudent::checkNpa).c_str());
}
/**
* askSalary
* Asks for the salary and calls the verifier to make sure  it's a correct format
*
* @return an USINT - the salary that the user inputs
*/
UINT AskProfessor::askSalary()
{
    return atoi(this->askMethod("Donnez le salaire", errorNumber, CheckPersonProfessorStudent::checkSalary).c_str());
}
