/*==============================================================*
 | Implementation file CompareComportementNpaDesc.cpp
 |    implements : CompareComportementNpaDesc class
 |
...
#include "CompareComportementNpaDesc.h"
...
*/
bool CompareComportementNpaDesc::compare(Person * person1, Person * person2)
{
...
* @return bool    : result of comparison
*/
bool CompareComportementNpaDesc::egality(Person * person1, Person * person2)
{
    return person1->getNpa() == person2->getNpa();
}
...
* @return bool    : result of comparison
*/
bool CompareComportementNpaDesc::egality(Person * person1, std::string value)
{
