/*==============================================================*
 | Implementation file CompareComportementSalaryDesc.cpp
 |    implements : CompareComportementSalaryDesc class
 |
...
#include "CompareComportementSalaryDesc.h"
#include "../Professor.h"
...
*/
bool CompareComportementSalaryDesc::compare(Person * person1, Person * person2)
{
...
* @return bool    : result of comparison
*/
bool CompareComportementSalaryDesc::egality(Person * person1, Person * person2)
{
    Professor * professor1 = dynamic_cast<Professor *>(person1);
    Professor * professor2 = dynamic_cast<Professor *>(person2);
...
* @return bool    : result of comparison
*/
bool CompareComportementSalaryDesc::egality(Person * person1, std::string value)
{
    // Try to cast
