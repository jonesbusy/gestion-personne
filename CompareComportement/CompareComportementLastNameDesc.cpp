/*==============================================================*
 | Implementation file CompareComportementLastNameDesc.cpp
 |    implements : CompareComportementLastNameDesc class
 |
...
#include "CompareComportementLastNameDesc.h"
...
*/
bool CompareComportementLastNameDesc::compare(Person * person1, Person * person2)
{
...
* @return bool    : result of comparison
*/
bool CompareComportementLastNameDesc::egality(Person * person1, Person * person2)
{
    return person1->getLastName() == person2->getLastName();
}
...
* @return bool    : result of comparison
*/
bool CompareComportementLastNameDesc::egality(Person * person1, std::string value)
{
