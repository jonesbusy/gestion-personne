#ifndef COMPARECOMPORTEMENTDATEDESC_H_INCLUDED
#define COMPARECOMPORTEMENTDATEDESC_H_INCLUDED
...
* @version	1.0
*/
class CompareComportementDateDesc : public I_CompareComportement
{
...
#endif // COMPARECOMPORTEMENTDATEDESC_H_INCLUDED
