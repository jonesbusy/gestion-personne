/*==============================================================*
 | Implementation file CompareComportementDateAsc.cpp
...
#include "CompareComportementDateAsc.h"
...
*/
bool CompareComportementDateAsc::compare(Person * person1, Person * person2)
{
...
* @return bool    : result of comparison
*/
bool CompareComportementDateAsc::egality(Person * person1, Person * person2)
{
    return *(person1->getBirthday()) == *(person2->getBirthday());
}
...
* @return bool    : result of comparison
*/
bool CompareComportementDateAsc::egality(Person * person1, std::string value)
{
